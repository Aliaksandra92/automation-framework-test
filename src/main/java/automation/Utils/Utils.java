...
public class Utils {
    ...
    public static boolean takeScreenshot() {
        ...
        try {
        FileCopyUtils.copy(file, new File( Constants.SCREENSHOTS_FOLDER + generateRandomString(Constants.SCEENSHOT_NAME_LENGTH) + Constants.SCREENSHOT_EXTENSION));
            return true;
        } catch (IOException e) {
            e.printStackTrace();
            return false;
    ...
    private static String generateRandomString(int length){
        String seedChars = "ABCDEFGHIJKLMNOPQRSTUWXYZ";
